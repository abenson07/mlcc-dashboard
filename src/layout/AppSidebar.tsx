...
const mainNavSections: NavSection[] = [
  {
    ...
    title: "Neighbors",
    icon: <GroupIcon />,
    rootPath: "/old-admin/neighbors",
    pathPrefixes: ["/old-admin/neighbors"],
    items: [
      {
        name: "Duplicate members",
        path: "/old-admin/neighbors/duplicate-memberships",
        pro: false,
      },
    ],
  },
  {
    ...
    title: "Volunteers",
    icon: <TaskIcon />,
    rootPath: "/old-admin/volunteers",
    pathPrefixes: ["/old-admin/volunteers"],
    items: [],
  },
  {
    id: "routes",
    title: "Routes",
    icon: <ArrowRightIcon />,
    rootPath: "/old-admin/routes",
    pathPrefixes: ["/old-admin/routes"],
    items: [],
  },
  {
    id: "businesses",
    title: "Businesses",
    icon: <BoxIcon />,
    rootPath: "/old-admin/businesses",
    pathPrefixes: ["/old-admin/businesses"],
    items: [],
  },
  {
    id: "sponsorship",
    title: "Sponsorship",
    icon: <PieChartIcon />,
    rootPath: "/old-admin/sponsorship",
    pathPrefixes: ["/old-admin/sponsorship", "/old-admin/billing"],
    items: [],
  },
  {
    id: "communications",
    ...
    icon: <MailIcon />,
    rootPath: "/old-admin/communications",
    pathPrefixes: ["/old-admin/communications", "/old-admin/marketing/email"],
    items: [
      {
        name: "QR codes",
        path: "/old-admin/communications?view=qr-codes",
  ...
  },
  {
    ...
    title: "Events",
    icon: <CalenderIcon />,
    rootPath: "/old-admin/events/cms",
    pathPrefixes: ["/old-admin/events/cms", "/old-admin/events/edit", "/old-admin/events/new"],
    items: [],
  },
  {
    id: "commerce",
...
const navItems: NavItem[] = [
  ...
  },
  {
    icon: <UserCircleIcon />,
    name: "User Profile",
    path: "/old-admin/profile",
  },
  {
    name: "Forms",
    icon: <ListIcon />,
    subItems: [{ name: "Form Elements", path: "/old-admin/form-elements", pro: false }],
  },
  {
    name: "Tables",
    icon: <TableIcon />,
    subItems: [
      { name: "Basic Tables", path: "/old-admin/basic-tables", pro: false },
      { name: "Mercury-style table", path: "/old-admin/mercury-table", pro: false },
      { name: "Table widgets", path: "/old-admin/table-widgets", pro: false },
    ],
  },
  {
    name: "Pages",
    icon: <PageIcon />,
    subItems: [
      { name: "Blank Page", path: "/old-admin/blank", pro: false },
      { name: "404 Error", path: "/old-admin/error-404", pro: false },
    ],
  },
];
...
const othersItems: NavItem[] = [
  {
    ...
    name: "Charts",
    subItems: [
      { name: "Line Chart", path: "/old-admin/line-chart", pro: false },
      { name: "Bar Chart", path: "/old-admin/bar-chart", pro: false },
    ],
  },
  {
    icon: <BoxCubeIcon />,
    name: "UI Elements",
    subItems: [
      { name: "Alerts", path: "/old-admin/alerts", pro: false },
      { name: "Avatar", path: "/old-admin/avatars", pro: false },
      { name: "Badge", path: "/old-admin/badge", pro: false },
      { name: "Buttons", path: "/old-admin/buttons", pro: false },
      { name: "Images", path: "/old-admin/images", pro: false },
      { name: "Videos", path: "/old-admin/videos", pro: false },
    ],
  },
  {
    icon: <PlugInIcon />,
