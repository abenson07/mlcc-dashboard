...
const mainNavSections: NavSection[] = [
  {
    ...
    title: "Neighbors",
    icon: <GroupIcon />,
    rootPath: "/admin/neighbors",
    pathPrefixes: ["/admin/neighbors"],
    items: [
      {
        name: "Duplicate members",
        path: "/admin/neighbors/duplicate-memberships",
        pro: false,
      },
    ],
  },
  {
    ...
    title: "Volunteers",
    icon: <TaskIcon />,
    rootPath: "/admin/volunteers",
    pathPrefixes: ["/admin/volunteers"],
    items: [],
  },
  {
    id: "routes",
    title: "Routes",
    icon: <ArrowRightIcon />,
    rootPath: "/admin/routes",
    pathPrefixes: ["/admin/routes"],
    items: [],
  },
  {
    id: "businesses",
    title: "Businesses",
    icon: <BoxIcon />,
    rootPath: "/admin/businesses",
    pathPrefixes: ["/admin/businesses"],
    items: [],
  },
  {
    id: "sponsorship",
    title: "Sponsorship",
    icon: <PieChartIcon />,
    rootPath: "/admin/sponsorship",
    pathPrefixes: ["/admin/sponsorship", "/admin/billing"],
    items: [],
  },
  {
    id: "communications",
    ...
    icon: <MailIcon />,
    rootPath: "/admin/communications",
    pathPrefixes: ["/admin/communications", "/admin/marketing/email"],
    items: [
      {
        name: "QR codes",
        path: "/admin/communications?view=qr-codes",
  ...
  },
  {
    ...
    title: "Events",
    icon: <CalenderIcon />,
    rootPath: "/admin/events/cms",
    pathPrefixes: ["/admin/events/cms", "/admin/events/edit", "/admin/events/new"],
    items: [],
  },
  {
    id: "commerce",
    title: "Commerce",
    icon: <BoxCubeIcon />,
    rootPath: "/admin/commerce/tshirt-preorders",
    pathPrefixes: ["/admin/commerce"],
    items: [
      {
        name: "T-shirt preorders",
        path: "/admin/commerce/tshirt-preorders",
        pro: false,
      },
      {
        name: "Fundraising",
        path: "/admin/commerce/fundraising",
        pro: false,
      },
    ],
  },
...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    subItems: [
      ...
      { name: "Mercury-style table", path: "/admin/mercury-table", pro: false },
      { name: "Table widgets", path: "/admin/table-widgets", pro: false },
    ],
  },
  {
    name: "Pages",
