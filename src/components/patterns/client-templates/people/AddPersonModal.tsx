...
import type { MemberRow, MembershipType, NeighborRow, VolunteerRow } from "@/data/mocks/people";
...
const MEMBERSHIP_TYPES: MembershipType[] = ["household", "individual", "business-affiliate"];
const MEMBERSHIP_TYPE_LABEL: Record<MembershipType, string> = {
  household: "Household",
  individual: "Individual",
  "business-affiliate": "Business Affiliate",
};
