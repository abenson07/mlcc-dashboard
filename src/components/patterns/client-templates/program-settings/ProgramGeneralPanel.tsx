...
/** General settings for the generic Program settings page. */
export function ProgramGeneralPanel() {
    ...
    <VStack gap={6}>
      ...
      <Card padding={4}>
        <VStack gap={4}>
          <SettingsRow
            label="Published"
            description="Make this program visible to students on MidwestEA.com"
            control={
              <Switch
                label="Published"
                isLabelHidden
          ...
          <SettingsRow
            ...
            description="Allow new students to enroll in upcoming classes"
            control={
              <Switch
                label="Accepting enrollment"
                isLabelHidden
          ...
          <SettingsRow
            ...
            description="Highlight this program on the MidwestEA.com homepage"
            control={
              <Switch
                label="Featured on website"
                isLabelHidden
