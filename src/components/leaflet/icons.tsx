export function IconChevronsUpDown() {
  return (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" aria-hidden>
      <path d="M7 15l5 5 5-5M7 9l5-5 5 5" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" />
    </svg>
  );
}
...
export function IconMegaphone() {
  return (
    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" aria-hidden>
      <path d="M3 11v2a2 2 0 002 2h2l8 4V5L7 9H5a2 2 0 00-2 2z" stroke="currentColor" strokeWidth="1.75" />
    </svg>
  );
}
...
export function IconBell() {
  return (
    <svg width="13" height="13" viewBox="0 0 24 24" fill="none" aria-hidden>
      <path d="M18 8a6 6 0 10-12 0c0 7-3 9-3 9h18s-3-2-3-9" stroke="currentColor" strokeWidth="1.75" />
    </svg>
  );
}
...
export function IconRepeat() {
  return (
    <svg width="13" height="13" viewBox="0 0 24 24" fill="none" aria-hidden>
      <path d="M17 1l4 4-4 4M3 11V9a4 4 0 014-4h14M7 23l-4-4 4-4M21 13v2a4 4 0 01-4 4H3" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" />
    </svg>
  );
}
...
export function IconVolume() {
  return (
    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" aria-hidden>
      ...
      <path d="M15.54 8.46a5 5 0 010 7.07M19.07 4.93a10 10 0 010 14.14" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" />
    </svg>
  );
}

export function IconLayoutDashboard() {
  return <svg width="16" height="16" viewBox="0 0 24 24" fill="none" aria-hidden><rect x="3" y="3" width="8" height="8" rx="1.5" stroke="currentColor" strokeWidth="1.75"/><rect x="13" y="3" width="8" height="5" rx="1.5" stroke="currentColor" strokeWidth="1.75"/><rect x="13" y="10" width="8" height="11" rx="1.5" stroke="currentColor" strokeWidth="1.75"/><rect x="3" y="13" width="8" height="8" rx="1.5" stroke="currentColor" strokeWidth="1.75"/></svg>;
}

export function IconBike() {
  return <svg width="16" height="16" viewBox="0 0 24 24" fill="none" aria-hidden><circle cx="5.5" cy="17.5" r="3.5" stroke="currentColor" strokeWidth="1.75"/><circle cx="18.5" cy="17.5" r="3.5" stroke="currentColor" strokeWidth="1.75"/><path d="M9 17.5h5M12 6l3 4M9 10l3 7.5M12 6H8l-2 4.5" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round"/></svg>;
}

export function IconMap() {
  return <svg width="16" height="16" viewBox="0 0 24 24" fill="none" aria-hidden><path d="M9 18l-6 3V6l6-3 6 3 6-3v15l-6 3-6-3z" stroke="currentColor" strokeWidth="1.75" strokeLinejoin="round"/><path d="M9 3v15M15 6v15" stroke="currentColor" strokeWidth="1.75"/></svg>;
}

export function IconRoute() {
  return <svg width="16" height="16" viewBox="0 0 24 24" fill="none" aria-hidden><circle cx="6" cy="19" r="2" stroke="currentColor" strokeWidth="1.75"/><circle cx="18" cy="5" r="2" stroke="currentColor" strokeWidth="1.75"/><path d="M8 17l5-10 3 4" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round"/></svg>;
}

export function IconHandshake() {
  return <svg width="16" height="16" viewBox="0 0 24 24" fill="none" aria-hidden><path d="M11 12l2 2m-2-2l-2 2m4-2l3 3m-7-3l-3 3M7 10l2-2m8 4l2-2M5 14l2-2m10 4l2-2" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round"/></svg>;
}

export function IconCalendarCheck() {
  return <svg width="16" height="16" viewBox="0 0 24 24" fill="none" aria-hidden><rect x="3" y="5" width="18" height="16" rx="2" stroke="currentColor" strokeWidth="1.75"/><path d="M8 3v4M16 3v4M3 10h18M9 15l2 2 4-4" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round"/></svg>;
}
...
export function IconMail() {
  return <svg width="14" height="14" viewBox="0 0 24 24" fill="none" aria-hidden><rect x="3" y="5" width="18" height="14" rx="2" stroke="currentColor" strokeWidth="1.75"/><path d="M3 7l9 6 9-6" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round"/></svg>;
}
