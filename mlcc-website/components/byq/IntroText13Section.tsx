      ...
      <div className="px-8 max-[767px]:px-4">
        <div className="mx-auto w-full max-w-[1800px]">
          <div className="py-40 max-[767px]:py-20">
            <div className="grid grid-cols-2 gap-4 max-[767px]:grid-cols-1 max-[767px]:gap-6">
              <div className="max-w-[35.25rem] max-[767px]:w-full max-[767px]:max-w-none">
              ...
              <div className="font-body text-base leading-6 font-normal text-sparkles-navy">
                ...
                line after line, showing flow, hierarchy, and balance. You can read it or ignore it, because its only job
                is to hold the silence. Imagine this copy as scaffolding: strong, temporary, replaceable. Each sentence
                arrives without purpose, except to suggest weight and movement in the layout. The words lean forward,
                repeating, echoing, circling around themselves. They are not here to tell a story, only to show where a
                story could be told.
              </div>
            </div>
          </div>
