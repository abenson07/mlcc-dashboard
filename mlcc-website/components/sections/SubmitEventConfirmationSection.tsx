...
export function SubmitEventConfirmationSection() {
  return (
    <section
      className="bg-sparkles-cream py-20 max-[767px]:py-16"
      data-editable="true"
      data-editable-type="section"
      data-editable-id="submit-event.confirmation"
      data-editable-label="Submit Event Confirmation"
    >
        ...
        <div className="mx-auto w-full max-w-[1800px]">
          <div className="flex flex-col items-center justify-center rounded-2xl bg-sparkles-blue px-8 py-32 max-[767px]:px-4 max-[767px]:py-24">
            <div className="flex max-w-[42.5rem] flex-col items-center gap-6 text-center max-[767px]:gap-5">
              <SectionLabel>Event received</SectionLabel>
              ...
              <p className="m-0 max-w-[32rem] font-body text-xl leading-7 font-normal text-sparkles-navy max-[767px]:text-base max-[767px]:leading-6">
                We&apos;ve received your submission. A volunteer will review it against our community
                guidelines and reach out by email if we have questions. If it&apos;s approved, we&apos;ll
                add it to the events calendar so neighbors can find it.
              </p>

              <div className="flex flex-row flex-wrap items-center justify-center gap-2">
                <PrimaryButton href="/events" label="Browse events" />
                <SecondaryButton href="/submit-event" label="Submit another" />
              </div>
            </div>
          </div>
        </div>
...
export default SubmitEventConfirmationSection;
