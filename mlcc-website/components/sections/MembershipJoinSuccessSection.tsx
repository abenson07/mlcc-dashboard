...
export function MembershipJoinSuccessSection() {
  return (
        ...
        <div className="mx-auto w-full max-w-[1800px] py-40 max-[767px]:py-20">
          <div className="mx-auto flex max-w-[36rem] flex-col items-center gap-6 text-center">
            ...
            <p className="m-0 font-body text-base leading-6 text-sparkles-muted">
              Your membership is confirmed and a receipt is on its way to your inbox. Thank you
              for supporting the neighborhood.
            </p>
            <Link
              href="/membership"
...
export default MembershipJoinSuccessSection;
