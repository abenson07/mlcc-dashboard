...
export function mapRowToMarketingEvent(row: PublishedEventRow): Event | null {
  ...
  return {
    ...
    imageAspect: fd.image_aspect === "portrait" ? "portrait" : undefined,
    imagePosition: fd.image_position === "right" ? "right" : undefined,
...
function overlayStaticWithRow(base: Event, row: PublishedEventRow): Event {
  ...
  return {
    ...
    imageAspect: mapped.imageAspect ?? base.imageAspect,
    imagePosition: mapped.imagePosition ?? base.imagePosition,
