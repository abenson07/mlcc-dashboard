...
export const SITE_ROUTES: RouteTrack[] = [
  ...
  {
    path: "/submit-story/confirmation",
    label: "Submit Story Confirmation",
    layout: "in-progress",
    content: "in-progress",
    polish: "not-started",
  },
  ...
  {
    path: "/submit-event/confirmation",
    label: "Submit Event Confirmation",
    layout: "in-progress",
    content: "in-progress",
    polish: "not-started",
  },
  ...
  {
    path: "/join-the-board/confirmation",
    label: "Join the Board Confirmation",
    layout: "in-progress",
    content: "in-progress",
    polish: "not-started",
  },
